...
class PollWorker(val context: Context, workerParams: WorkerParameters)
    ...
    override fun doWork(): Result {
        val query = QueryPreferrence.getStoredQuery(context)
        val lastResultId = QueryPreferrence.getLastResultId(context)
        ...
        if (resultId == lastResultId) {
            ...
            QueryPreferrence.setLastResultId(context, resultId)
